...
struct AnariMetalDevice : public helium::BaseDevice
{
  /////////////////////////////////////////////////////////////////////////////
  ...
  AnariMetalDevice(ANARIStatusCallback defaultCallback, const void *userPtr);
  AnariMetalDevice(ANARILibrary);
  ~AnariMetalDevice() override;
